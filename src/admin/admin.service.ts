  ...
  async openDriverDocumentStream(
    ...
    try {
      ...
      throw new NotFoundException(
        "Fayl serverda topilmadi. Agar yangi deploydan keyin bo‘lsa: fayllar ephemeral diskda edi — SALOM_UPLOAD_ROOT ni Render persistent disk ga qarang (render.yaml).",
      );
    }
