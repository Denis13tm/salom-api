...
export const envValidationSchema = Joi.object({
  ...
  COMMISSION_WALLET_MIN_BROADCAST_BALANCE_UZS: Joi.number()
    .min(-1_000_000)
    .default(10_000),
  ...
  ADMIN_DRIVER_BROADCAST_MAX_TARGETS: Joi.number()
    .min(1)
    .max(100_000)
    .default(15_000),
  ...
  ESKIZ_API_BASE: Joi.string()
    .uri()
    .optional()
    .default("https://notify.eskiz.uz"),
