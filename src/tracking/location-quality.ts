...
export function isPingQualityOk(
  input: { lat: number; lng: number; accuracyM?: number; speedKmh?: number; recordedAt?: string },
...
function distanceMetersHaversine(lat1: number, lng1: number, lat2: number, lng2: number) {
  const R = 6371000;
